...
plot_rule_of_thumb_benefits(dt0, test_start_times, test_park_times, benefits_dict, "Rule of Thumb", 1)
savefig("benefits_rot.png")

plot_rule_of_thumb_benefits(dt0, test_start_times, test_park_times, benefits_dict, "Optimized", 2)
savefig("benefits_optimized.png")

plot_rule_of_thumb_benefits(dt0, test_start_times, test_park_times, benefits_dict, "Stochastic Optimized", 3)
savefig("benefits_optimized_stoch.png")

plot_rule_of_thumb_benefits(dt0, test_start_times, test_park_times, benefits_dict, "Stochastic Rule of Thumb", 4)
savefig("benefits_stoch_rot.png")

plot_rule_of_thumb_benefits(dt0, test_start_times, test_park_times, benefits_dict, "Stochastic Baseline Rule of Thumb", 5)
savefig("benefits_stoch_rot_baseline.png")


plot_rule_of_thumb_benefits_difference(dt0, test_start_times, test_park_times, benefits_dict, "Rule of Thumb - Baseline", 1)
savefig("differenced_rot.png")

plot_rule_of_thumb_benefits_difference(dt0, test_start_times, test_park_times, benefits_dict, "Optimized - Baseline", 2)
savefig("differenced_optimized.png")

plot_rule_of_thumb_benefits_difference(dt0, test_start_times, test_park_times, benefits_dict, "Stochastic Optimized - Baseline", 3)
savefig("differenced_optimized_stoch.png")

plot_rule_of_thumb_benefits_difference(dt0, test_start_times, test_park_times, benefits_dict, "Stochastic Rule of Thumb - Baseline", 4)
savefig("differenced_stoch_rot.png")

plot_rule_of_thumb_benefits_difference(dt0, test_start_times, test_park_times, benefits_dict, "Baseline - Baseline", 5)
savefig("differenced_stoch_rot_baseline.png")
